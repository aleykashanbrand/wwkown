#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Aley
...
jalan("\033[1;93m▇▇\033[1;92m              ALEY BAD BOY        \033[1;93m▇▇")
...
jalan("\033[1;93m▇▇\033[1;93m         WhatsApp  Num +923554576001 \033[1;93m▇▇")
jalan("\033[1;93m ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇")
print "\033[1;95m----*----*----*----*----*----*----*----*----*----*----*--ALEY--*----*----*----*----*----*----*----*----*----*----*----*----*----*----*
CorrectUsername = "wwk"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.facebook.comTermuxmaster.Aley.com')
    else:
...
def login():
    ...
    time.sleep(0.05)
    print "\033[1;92m-«-----------------\033[1;91mALEY BADBOY\033[1;95m----------------»"
